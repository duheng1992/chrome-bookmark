...
function ToolBar({ onSearch, onTagSearch, onThemeChange }) {
...
return <Row className='list-row mb-4'>
    ...
    <Col span={2} className="flex-xy-center">
      <Switch checkedChildren={Sun} unCheckedChildren={Moon} defaultChecked onChange={checked => onThemeChange(checked)} />
    </Col>
  </Row>
}
